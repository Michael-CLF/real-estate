...
export interface ShowingRequest {
  ...
  /**
   * Human-readable reference generated by the
   * seller email notification Function.
   *
   * Existing or newly-created requests may briefly
   * omit this value while the trigger is processing.
   */
...
export interface RespondToAlternateShowingTimeInput {
  showingRequestUid: string;
  buyerUid: string;
  responseMessage: string;
}
