...
export type UtahContractType =
  'navstreet_utah_residential_sale_2026';

export type UtahFinancingType =
  | 'cash'
  | 'conventional'
  | 'fha'
  | 'va'
...
export type UtahDisclosureStatus =
  | 'unselected'
  | 'received'
  | 'pending';

export interface UtahOfferTerms {
  ...
  readonly settlement: {
    ...
    readonly specialAssessmentPayer:
      | 'unselected'
      | 'buyer'
      | 'seller'
      | 'split';
    readonly hoaTransferFeePayer:
      | 'unselected'
      | 'buyer'
      | 'seller'
      | 'split';
  ...
  readonly disclosures: {
    ...
    readonly leadPaintStatus:
      | 'unselected'
      | 'received'
      | 'built_1978_or_later'
      | 'exempt';
    readonly leadInspectionSelection:
      | 'unselected'
      | 'ten_days'
      | 'waived'
      | 'other_period';
    readonly leadInspectionDays: number;
    readonly hoaDocumentsStatus:
      | 'unselected'
      | 'received'
      | 'pending'
      | 'not_applicable';
...
export const UTAH_RESIDENTIAL_CONTRACT_DEFINITION = {
  ...
  description:
    'NavStreet-written agreement for a Utah residential resale between the parties.',
} as const;