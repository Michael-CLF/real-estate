...
export const wisconsinOfferDisplayAdapter: StateOfferDisplayAdapter<WisconsinOfferTerms> = {
  stateCode: 'WI',
  display(terms) {
    return {
      agreementTitle: 'NavStreet Wisconsin Residential Purchase and Sale Agreement',
      documentLabel: 'NavStreet Wisconsin agreement PDF',
