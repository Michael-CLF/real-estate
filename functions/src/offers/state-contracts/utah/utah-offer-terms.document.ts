...
export type UtahContractType = 'navstreet_utah_residential_sale_2026';
export type UtahFinancingType = 'cash' | 'conventional' | 'fha' | 'va' | 'usda';
export type UtahDisclosureStatus = 'unselected' | 'received' | 'pending';

/** One immutable version of NavStreet's Utah residential agreement. */
export interface UtahOfferTermsDocument {
  readonly stateCode: 'UT';
  readonly contractType: UtahContractType;
  ...
  readonly purchase: {
    ...
    readonly financingType: UtahFinancingType | 'unselected';
  ...
  readonly propertyItems: {
    ...
    readonly waterRightsIncluded: boolean | null;
    readonly excludedWaterRights: string;
  };
  readonly settlement: {
  ...
  readonly disclosures: {
    readonly propertyConditionStatus: UtahDisclosureStatus;
    ...
    readonly sellerReportsCurrentMethContamination: boolean | null;
    readonly methamphetamineContaminationAcknowledged: boolean | null;
  };
...
export const UTAH_RESIDENTIAL_CONTRACT_DEFINITION = {
  contractType: 'navstreet_utah_residential_sale_2026',
  formId: 'NAVSTREET-UT-RESIDENTIAL-2026',
  formName: 'NavStreet Utah Residential Purchase and Sale Agreement',
  effectiveDate: '2026-09-25',
  revisionDate: '2026-09-25',
  description: 'NavStreet-written agreement for a Utah residential resale between the parties.',
} as const;
